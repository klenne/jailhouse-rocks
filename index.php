...
<body>
					...
					<div class="box">
						...
						<div class="content">
							...
							<footer class="align-center">
								<a href="https://www.uppermag.com/rock-and-roll/" target="_blank" class="button alt">Saiba Mais</a>
							</footer>
						</div>
					</div>
				</div>
					...
					<div class="box">
						...
						<div class="content">
							...
							<footer class="align-center normalize-box">
								<a href="cadastro.php" class="button alt">Cadastre-se Agora</a>
							</footer>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 col-team text-center">
					<div class="box bx-team">
						...
						<ul class="icons">
							...
							<li><a href="https://www.linkedin.com" class="icon fa-linkedin" target="_blank"><span class="label">linkedin</span></a></li>
				...
				<div class="col-md-4 col-sm-6 col-team text-center">
					<div class="box bx-team">
						...
						<ul class="icons">
							<li><a href="https://www.github.com/klenne" class="icon fa-github" target="_blank"><span class="label">Github</span></a></li>
							<li><a href="https://web.facebook.com/guilherme.klesse" class="icon fa-facebook" target="_blank"><span class="label">Facebook</span></a></li>
							<li><a href="https://www.linkedin.com/in/guilherme-klesse-de-miranda-5989a8170/" class="icon fa-linkedin" target="_blank"><span class="label">linkedin</span></a></li>
				...
				<div class="col-md-4 col-sm-6 col-team text-center">
					<div class="box bx-team">
						...
						<ul class="icons">
							<li><a href="https://www.github.com/H1berto" class="icon fa-github" target="_blank"><span class="label">Github</span></a></li>
							<li><a href="https://web.facebook.com/humberto.barone" class="icon fa-facebook" target="_blank"><span class="label">Facebook</span></a></li>
							<li><a href="https://www.linkedin.com/in/humberto-barone/" class="icon fa-linkedin" target="_blank"><span class="label">linkedin</span></a></li>
				...
				<div class="col-md-4 col-sm-6 col-team ml-20 text-center">
					<div class="box bx-team">
						...
						<ul class="icons">
							<li><a href="https://www.github.com/klenne" class="icon fa-github" target="_blank"><span class="label">Github</span></a></li>
							<li><a href="https://web.facebook.com/marcilio.caetano.9" class="icon fa-facebook" target="_blank"><span class="label">Facebook</span></a></li>
							<li><a href="https://www.linkedin.com/in/jose-marc%C3%ADlio-da-silva-caetano-a28472115/" class="icon fa-linkedin" target="_blank"><span class="label">linkedin</span></a></li>
	...
	<footer id="footer">
		...
		<div class="copyright">
			Apoiado por <a href="https://institutocriativo.org.br/" target="_blank">Instituto Criativo</a>
		</div>
	</footer>
